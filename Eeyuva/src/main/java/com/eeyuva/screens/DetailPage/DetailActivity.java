        ...
        switch (id) {
            case R.id.action_search:
               // showDialog();
                ...
                Utils.getSearchQuery(DetailActivity.this,etSearch,btnDoSearch,ll_searchView);
                break;
            ...
            mBtnTakePhoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mBtnTakePhoto.getText().toString().trim().equalsIgnoreCase("Post")) {
                        if (mPhoto) {
                            if(Utils.validateUserPost(DetailActivity.this,mEdtModule.getText().toString().trim(),
                                ...
                                Utils.makeToast(DetailActivity.this,"Please enter all the details");
                            }
                        } else {
                            uploadVideo();
                        }
