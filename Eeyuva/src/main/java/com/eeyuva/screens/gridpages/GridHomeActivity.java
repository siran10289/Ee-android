 ...
 */
public class GridHomeActivity extends ButterAppCompatActivity implements GridContract.View, GridContract.AdapterCallBack,DialogListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_search:
                Utils.getSearchQuery(GridHomeActivity.this,etSearch,btnDoSearch,ll_searchView);
                break;
    ...
    public void showModuleVideoPhoto(final File photoFile, int i) {
        try {
            ...
            mBtnTakePhoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mBtnTakePhoto.getText().toString().trim().equalsIgnoreCase("Post")) {
                        if (mPhoto) {
                            if(Utils.validateUserPost(GridHomeActivity.this,mEdtModule.getText().toString().trim(),
                                ...
                                Utils.makeToast(GridHomeActivity.this,"Please enter all the details");
                            }
                        } else {
                            uploadVideo();
                        }
            ...
            mEdtModule.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AppDialogManager.ModuleChooserDialog(GridHomeActivity.this,GridHomeActivity.this,mPresenter.getModules());
                }
            });
    ...
    private void uploadVideo() {
        class UploadVideo extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                uploading = ProgressDialog.show(GridHomeActivity.this, "Uploading File", "Please wait...", false, false);
            }
    ...
    public void setCatagoryList(CatagoryList catagoryListPojo) {
        AppDialogManager.catagoryChooserDialog(GridHomeActivity.this,GridHomeActivity.this,catagoryListPojo.getCatagoryList());
    }
    @Override
