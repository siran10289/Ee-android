 ...
 */
public class PhotoListActivity extends ButterAppCompatActivity implements GridContract.View, GridContract.AdapterCallBack ,DialogListener{
...
//        mModuleList = mPresenter.getModules();
        mPresenter.getPhotoList(Constants.GridGetPhotoAlbum, mModuleId);
...
//        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_search:
                Utils.getSearchQuery(PhotoListActivity.this,etSearch,btnDoSearch,ll_searchView);
                break;
    ...
    public void setSelectItem(PhotoList rl) {
        mPresenter.getPhotoGalleryList(Constants.GridGetPhotoGallery, rl.getTrid());
    }
    ...
    public void showModuleVideoPhoto(final File photoFile, int i) {
        try {
            ...
            mBtnTakePhoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mBtnTakePhoto.getText().toString().trim().equalsIgnoreCase("Post")) {
                        if (mPhoto) {
                            if(Utils.validateUserPost(PhotoListActivity.this,mEdtModule.getText().toString().trim(),
                                ...
                                Utils.makeToast(PhotoListActivity.this,"Please enter all the details");
                            }
                        } else {
                            uploadVideo();
                        }
            ...
            mEdtModule.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AppDialogManager.ModuleChooserDialog(PhotoListActivity.this,PhotoListActivity.this,mPresenter.getModules());
                }
            });
    ...
    private void uploadVideo() {
        class UploadVideo extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                uploading = ProgressDialog.show(PhotoListActivity.this, "Uploading File", "Please wait...", false, false);
            }
    ...
    public void setCatagoryList(CatagoryList catagoryListPojo) {
        AppDialogManager.catagoryChooserDialog(PhotoListActivity.this,PhotoListActivity.this,catagoryListPojo.getCatagoryList());
    }
    @Override
