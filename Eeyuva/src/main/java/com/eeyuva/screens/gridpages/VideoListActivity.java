 ...
 */
public class VideoListActivity extends ButterAppCompatActivity implements GridContract.View, GridContract.AdapterCallBack,DialogListener {
...
//        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_search:
                Utils.getSearchQuery(VideoListActivity.this,etSearch,btnDoSearch,ll_searchView);
                break;
            ...
            mBtnok.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (sKeyword != null && sKeyword.length() != 0) {
                        mDialog.dismiss();
                        Intent intent =
                                new Intent(VideoListActivity.this, SearchActivity.class);
    ...
    public void showModuleVideoPhoto(final File photoFile, int i) {
        try {
            ...
            mBtnTakePhoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mBtnTakePhoto.getText().toString().trim().equalsIgnoreCase("Post")) {
                        if (mPhoto) {
                            if(Utils.validateUserPost(VideoListActivity.this,mEdtModule.getText().toString().trim(),
                                ...
                                Utils.makeToast(VideoListActivity.this,"Please enter all the details");
                            }
                        } else {
                            uploadVideo();
                        }
            ...
            mEdtModule.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AppDialogManager.ModuleChooserDialog(VideoListActivity.this,VideoListActivity.this,mPresenter.getModules());
                }
            });
    ...
    private void uploadVideo() {
        class UploadVideo extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                uploading = ProgressDialog.show(VideoListActivity.this, "Uploading File", "Please wait...", false, false);
            }
    ...
    public void setCatagoryList(CatagoryList catagoryListPojo) {
        AppDialogManager.catagoryChooserDialog(VideoListActivity.this,VideoListActivity.this,catagoryListPojo.getCatagoryList());
    }
    @Override
